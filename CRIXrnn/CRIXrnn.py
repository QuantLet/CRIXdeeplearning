...
from dldata.dldata import series_to_supervised_multi, results_rnn

#data
with open('dataset.pkl', 'rb') as input:
    dataset = pickle.load(input)
with open('Return.pkl', 'rb') as input:
    Return = pickle.load(input)
with open('TotalLabeled.pkl', 'rb') as input:
    TotalLabeled = pickle.load(input)
