...
print('Loading data...')
path = open(os.getcwd() + str("/Data.csv"), "r")
...
testLabeled = pd.read_pickle('C:\\Users\\BS\\Documents\\NewData\\Algorithm\\Portfolio comparison\\testLabeled.pkl')
prices = pd.read_pickle('C:\\Users\\BS\\Documents\\NewData\\Algorithm\\Portfolio comparison\\prices.pkl')
crix = pd.read_pickle('C:\\Users\\BS\\Documents\\NewData\\Algorithm\\Portfolio comparison\\crix.pkl')
Results = pd.read_pickle('C:\\Users\\BS\\Documents\\NewData\\Algorithm\\Portfolio comparison\\Results.pkl')



dataset = pd.read_pickle('C:\\Users\\BS\\Documents\\NewData\\Algorithm\\Portfolio comparison\\dataset.pkl')
